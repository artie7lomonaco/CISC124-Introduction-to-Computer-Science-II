...
public class Dictionary {
	 ...
	 */
	public TreeSet<String> getSet(int wordLen) {
	...
	public Map<Integer, TreeSet<String>> getMap() {
		return this.dicts;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(d.contains("first"));
//		System.out.println(d.contains("the"));
//		Map<Integer, TreeSet<String>> theMap = d.getMap();
//		theMap.clear();
//		System.out.println(d.size());
//		System.out.println(d.contains("the"));
//		System.out.println(theMap.size());
		
		TreeSet<String> aSet = d.getSet(5);
		aSet.clear();
		System.out.println(d.size());
		System.out.println(d.contains("first"));
